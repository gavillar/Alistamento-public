...
final class LoginErrorView: UIView {
    //MARK: - variables
    lazy var failureLabel = Create.label("Email ou Senha Incorretos", font: .boldSystemFont(ofSize: 20))
    lazy var instructionLabel = Create.label("Confira se seu Email e sua senha estão corretos.", font: .boldSystemFont(ofSize: 20))
